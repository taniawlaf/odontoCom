       ...
       <div class="card-box">
            ...
            {!! Form::open(['url'=>'/tiposTratamiento']) !!}
             ...
             <div class="form-group row mb-3">    
                {!! Form::label ('nombre','Nombre del tiposTratamiento',['class' => 'control-label']) !!}
                <div class= col-md-9>
                        {!! Form::text ('nombre',null,['placeholder'=>'Ingresa nombre del tiposTratamiento','class'=>'form-control']) !!}
                    </div>
                </div>
                ...
                <br>
                 <div class="form-group row mb-3">
                    ...
                    <div class= col-md-9>
                        {!! Form::number ('semestre', null,['placeholder'=>'Ingresa semestre del tiposTratamiento','class'=>'form-control']) !!}
                    </div>
                </div>
                ...
                <br>
                <br>  
            {!! Form::submit('Guardar tiposTratamiento',['class' => 'btn btn-success']) !!}
            {!! Form::close() !!}
        </div>
    </div>
</div>
